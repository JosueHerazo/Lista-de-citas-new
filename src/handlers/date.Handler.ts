...
export const getProducts = async (req: Request, res: Response) => {
    try {
        const ListDate = await List.findAll({
...
export const createProduct = async (req: Request, res: Response) => {
    try {
        ...
        const dateslist = await List.create(req.body)
...
export const getProductById = async (req: Request, res: Response) => {
    try {
        const { id } = req.params
        const ListDate = await List.findByPk(id)
...
export const getBarberos = async (req: Request, res: Response) => {
    try {
        const config = await List.findOne({ where: { service: '__barberos__' } })
        if (!config) {
...
export const saveBarberos = async (req: Request, res: Response) => {
    try {
        ...
        const existing = await List.findOne({ where: { service: '__barberos__' } })
        if (existing) {
