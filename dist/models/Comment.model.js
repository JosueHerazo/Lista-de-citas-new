...
const New_model_1 = __importDefault(require("./New.model")); // Importamos el default
let Comment = (() => {
    let _classDecorators = [(0, sequelize_typescript_1.Table)({ tableName: "comments" })];
    ...
    var Comment = _classThis = class extends _classSuper {
        constructor() {
            super(...arguments);
            this.text = __runInitializers(this, _text_initializers, void 0);
            this.userName = (__runInitializers(this, _text_extraInitializers), __runInitializers(this, _userName_initializers, void 0));
            this.newsId = (__runInitializers(this, _userName_extraInitializers), __runInitializers(this, _newsId_initializers, void 0));
    ...
    (() => {
        ...
        _newsId_decorators = [(0, sequelize_typescript_1.ForeignKey)(() => New_model_1.default), (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.INTEGER, allowNull: false })];
