...
const List_models_1 = __importDefault(require("./List.models"));
...
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.BOOLEAN(), allowNull: false, unique: true }),
